...
@section('content')
    ...
    <section class="mt-5">
        ...
        <template x-if="isProcessing">
            <div class="text-center">
                <div class="d-flex align-items-center justify-content-center">
                    <div class="icon-lg bg-gradient bg-warning">
                        <i class="ti ti-time fs-2"></i>
                    </div>
                </div>
                <h4 class="fw-bolder mt-4">@lang('Processing')</h4>
                <p>@lang('Please wait while we generate the voice over.')</p>
            </div>
        </template>
