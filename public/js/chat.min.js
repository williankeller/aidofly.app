...
/***/ "./resources/assets/scripts/pages/agents/chat/chat.js":
/*!************************************************************!*\
  !*** ./resources/assets/scripts/pages/agents/chat/chat.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _helpers_markdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../helpers/markdown */ "./resources/assets/scripts/helpers/markdown.js");
/* harmony import */ var eventsource_parser_stream__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! eventsource-parser/stream */ "./node_modules/eventsource-parser/dist/stream.js");
/* harmony import */ var _helpers_notification__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../helpers/notification */ "./resources/assets/scripts/helpers/notification.js");
  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("chat", function () {
    ...
    return {
      ...
      format: function format(message) {
        return message ? (0,_helpers_markdown__WEBPACK_IMPORTED_MODULE_2__.markdownToHtml)(message) : "";
      },
      submit: function submit() {
        var _this2 = this;
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var _data$get;
          var data, reference, message;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
              ...
              case 2:
                ...
                data = new FormData();
                data.append("prompt", _this2.prompt);

                // Get reference from the reference input
                reference = document.querySelector('[name="reference"]');
                if (reference) {
                ...
                message = {
                  ...
                  reference: (_data$get = data.get("reference")) !== null && _data$get !== void 0 ? _data$get : null
                }; // Add first user message to the conversation
                _this2.conversation.messages.push(message);
                _this2.cloneMessageTemplate(message.content, "user");

                // Clear the prompt after sending the message and save the previous one in case of an error
                _this2.temporaryPrompt = _this2.prompt;
                _this2.prompt = "";
                _this2.watingStream = true;
                // Create a new conversation for the assistant on load mode
                _this2.cloneMessageTemplate(null, "assistant");

                // Ask the assistant (perform the API request)
                _this2.ask(data, _this2.assistant);
              case 16:
              case "end":
                return _context.stop();
            }
      ...
      cloneMessageTemplate: function cloneMessageTemplate(content, role) {
        var templateId = role === "user" ? "#message-user-template" : "#message-ai-template";
        var template = document.querySelector(templateId).content.cloneNode(true);
        var messageText = template.querySelector("[data-message-element='content']");
        if (content !== null) {
      ...
      updateMessageContent: function updateMessageContent(content) {
        // Find the last assistant message
        var messageElements = document.querySelectorAll(".message-ai");
        if (messageElements.length > 0) {
          var lastMessageElement = messageElements[messageElements.length - 1];
          lastMessageElement.querySelector("[data-message-element='content']").innerHTML = this.format(content);
        }
      },
      ask: function ask(data, assistant) {
        var _this3 = this;
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          var response, stream, reader, message, pushed, _yield$reader$read, value, done, _conversation;
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _helpers_api__WEBPACK_IMPORTED_MODULE_1__["default"].post("/agent/chat/", data);
              case 3:
                response = _context2.sent;
                // Get the readable stream from the response body
                stream = response.body.pipeThrough(new TextDecoderStream()).pipeThrough(new eventsource_parser_stream__WEBPACK_IMPORTED_MODULE_4__.EventSourceParserStream()); // Get the reader from the stream
                ...
                _this3.promptUpdated = false;
                _this3.watingStream = false;
              case 12:
                if (false) {}
                if (_this3.autoScroll) {
                  window.scrollTo(0, document.body.scrollHeight);
                }
                _context2.next = 16;
                return reader.read();
              ...
              case 22:
                ...
                if (!pushed) {
                  _this3.conversation.messages.push(message);
                  pushed = true;
                }
                _this3.updateMessageContent(message.content);
              ...
              case 27:
                ...
                _conversation = JSON.parse(value.data);
                _this3.select(_conversation);
                _this3.isProcessing = false;
                return _context2.abrupt("continue", 12);
              case 32:
                ...
                _this3.prompt = _this3.temporaryPrompt;
                _this3.error(value.data);
                return _context2.abrupt("break", 38);
              case 36:
                _context2.next = 12;
                break;
      ...
      error: function error(msg) {
        ...
        (0,_helpers_notification__WEBPACK_IMPORTED_MODULE_3__.notification)(msg);
        console.error(msg);
      },
      ...
      select: function select(conversation) {
        var reference = document.querySelector('[name="reference"]');
        reference.value = conversation.uuid;

        // Add the title to the .page-heading element
        this.typing(conversation.title, document.querySelector(".page-heading"));
        var url = new URL(window.location.href);
        url.pathname = "/agent/chat/" + conversation.uuid;
        window.history.pushState({}, "", url);
      },
      typing: function typing(text, outputElement) {
        var speed = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 40;
        var index = 0;
      ...
      copy: function copy(message) {
        navigator.clipboard.writeText(message.content).then(function () {
          (0,_helpers_notification__WEBPACK_IMPORTED_MODULE_3__.notification)("Copied to clipboard!", "success");
        });
      },
...
/* harmony import */ var _chat_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat.js */ "./resources/assets/scripts/pages/agents/chat/chat.js");



(0,_chat_js__WEBPACK_IMPORTED_MODULE_2__.chat)();
