...
function listing() {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("list", function (basePath) {
    return {
      ...
      init: function init() {
        ...
        window.addEventListener("filter.filtered", function (e) {
          clearTimeout(timer);
          timer = setTimeout(function () {
            _this.params = e.detail;
            _this.currentPage = 1; // Reset to the first page for filtered results
      ...
      retrieveResources: function retrieveResources() {
        ...
        _helpers_api__WEBPACK_IMPORTED_MODULE_1__["default"].get(basePath, params).then(function (response) {
          ...
          _this2.pagination = list.pagination;
          if (_this2.resources.length === 0) {
            _this2.state = "empty";
          }
          _this2.isLoading = false;
          _this2.hasMore = _this2.currentPage < list.pagination.pages;
          _this2.total = list.pagination.total;
          ...
          _this2.state = "error";
          console.error(error);
          (0,_helpers_notification__WEBPACK_IMPORTED_MODULE_2__.notification)("An error occurred while loading the resources.");
        });
      },
      loadMore: function loadMore() {
        var _this3 = this;
        window.addEventListener("scroll", function () {
          if (_this3.hasMore && !_this3.isLoading && window.innerHeight + window.scrollY + 300 >= document.documentElement.scrollHeight) {
  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("filter", function () {
    ...
    return {
      ...
      init: function init() {
        ...
        this.filters.forEach(function (filter) {
          return _this4.params[filter.model] = null;
        });
        this.getCategories();
        this.bindKeyboardShortcuts();
        var sortparams = ["orderby", "dir"];
        sortparams.forEach(function (param) {
          _this4.$watch(param, function () {
            _this4.params.sort = null;
            if (_this4.orderby) {
              _this4.params.sort = _this4.orderby;
              if (_this4.dir) {
                _this4.params.sort += ":".concat(_this4.dir);
              }
            }
          });
        });
        this.$watch("params", function (params) {
          _this4.$dispatch("filter.filtered", params);
          _this4.updateUrl();
        });
        this.parseUrl();
      ...
      bindKeyboardShortcuts: function bindKeyboardShortcuts() {
        window.addEventListener("keydown", function (e) {
          if (e.metaKey && e.key === "k") {
            ...
            var _searchElement = document.querySelector('input[type="search"]');
            _searchElement.blur();
          }
        });
      },
      ...
      parseUrl: function parseUrl() {
        ...
        var _loop = function _loop(key) {
            ...
            var filter = _this6.filters.find(function (f) {
              return f.model == key;
            });
            if (!filter) {
              return 0; // continue
            ...
            _this6.params[key] = params.get(key);
          },
          _ret;
        for (var key in this.params) {
          _ret = _loop(key);
...
var signout = function signout() {
  return window.location.href = "/account/signout";
};
var unauthorizedAccess = function unauthorizedAccess() {
  console.error("Unauthorized access");
  (0,_notification__WEBPACK_IMPORTED_MODULE_0__.notification)("You have been disconnected!");
  signout();
};
...
_defineProperty(WaveElement, "observedAttributes", ["src", "wave-color", "progress-color", "cursor-color"]);
...
/* harmony import */ var _wave_element_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wave-element.js */ "./resources/assets/scripts/pages/agents/voiceover/wave-element.js");
/* harmony import */ var _voiceover_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./voiceover.js */ "./resources/assets/scripts/pages/agents/voiceover/voiceover.js");
/* harmony import */ var _components_listing_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../components/listing.js */ "./resources/assets/scripts/components/listing.js");





customElements.define("component-wave", _wave_element_js__WEBPACK_IMPORTED_MODULE_2__.WaveElement);
...
(0,_components_listing_js__WEBPACK_IMPORTED_MODULE_4__.listing)();
(0,_voiceover_js__WEBPACK_IMPORTED_MODULE_3__.voiceover)();
